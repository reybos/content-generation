...
/**
 * Simple test to verify the new structured organization works correctly
 */
function testSimpleStructure() {
    console.log('🧪 Testing new services structure (simple)...\n');
